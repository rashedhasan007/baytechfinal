...
function setData(){
  ...
  var dataRef1 = database.ref('/service-header2');
  var dataRef2 = database.ref('/service-longheader2');
  var dataRef3 = database.ref('/service-paragraph2');
  var dataRef4 = database.ref('/service-link2');
