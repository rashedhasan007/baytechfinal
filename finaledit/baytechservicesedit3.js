...
function setData(){
  ...
  var dataRef1 = database.ref('/service-header3');
  var dataRef2 = database.ref('/service-longheader3');
  var dataRef3 = database.ref('/service-paragraph3');
  var dataRef4 = database.ref('/service-link3');
