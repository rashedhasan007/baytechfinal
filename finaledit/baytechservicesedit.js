...
function setData(){
  ...
  var dataRef1 = database.ref('/service-header1');
  var dataRef2 = database.ref('/service-longheader1');
  var dataRef3 = database.ref('/service-paragraph1');
  var dataRef4 = database.ref('/service-link1');
